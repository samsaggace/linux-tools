...
syn match makeStatement contained "(\(abspath\|addprefix\|addsuffix\|basename\|dir\|notdir\|subst\|suffix\|filter\|filter-out\|findstring\|firstword\|flavor\|join\|lastword\|patsubst\|realpath\|shell\|sort\|strip\|wildcard\|word\|wordlist\|words\|origin\|foreach\|call\|info\|error\|warning\|if\|or\|and\|value\|eval\)\>"ms=s+1
